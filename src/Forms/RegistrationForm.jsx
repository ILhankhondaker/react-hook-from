...
const RegistrationForm = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <form
                className="bg-slate-200 w-auto p-10 rounded-lg shadow-md"
                ...
                <FieldSet label="Enter Your Basic Details">
                    ...
                    <Field label="Email" error={errors.email}>
                        <input
                            ...
                            className={`p-2 border box-border w-[300px] rounded-md ${!!errors.email
                                ? "border-red-500"
                                : "border-gray-200"
                                }`}
                            type="email"
                    ...
                    <Field label="Password" error={errors.password}>
                        <input
                            ...
                            className={`p-2 border box-border w-[300px] rounded-md ${!!errors.password
                                ? "border-red-500"
                                : "border-gray-200"
                                }`}
                            type="password"
                    ...
                    <Field label="Full Name" error={errors.fname}>
                        <input
                            ...
                            className={`p-2 border box-border w-[300px] rounded-md ${!!errors.fname
                                ? "border-red-500"
                                : "border-gray-200"
                                }`}
                            type="text"
